...
urlpatterns = [
   ...
   path('Eduction/<filier>-List/',views.FilierPanelPage,name ="filier-panel-page"),
   ...
   path('Eduction/<filier>/Semester-Detail/',views.SemesterPanelPage,name ="semster-panel-page"),
